...
namespace ExceptionHandling2
{
    class Program
    {
        static void Main()
        {
            ...
            catch (SystemException ex) //catches all unhandled .net exceptions
            {
                Console.WriteLine(ex.Message);
            }
            catch (ApplicationException ex)//catches all unhandled user defined exceptions
            {
                Console.WriteLine(ex.Message);
            }
            catch (Exception ex) //catches all other unhandled exceptions
            {
                Console.WriteLine(ex.Message);
            }
